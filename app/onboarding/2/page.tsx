...
const options = ["Preto", "Castanho", "Loiro", "Ruivo"]
...
export default function OnboardingQuestion2() {
  ...
  const handleNext = () => {
    if (selected) {
      localStorage.setItem("onboarding_q2", selected)
      ...
      <div className="w-full max-w-[500px] mx-auto">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm text-[#FF69B4] font-semibold">Pergunta 2 de 4</span>
        ...
        <h2 className="text-xl font-bold mb-2">Pergunta 2</h2>
        <p className="text-base text-gray-700 mb-8">Cabelo cor atual</p>
